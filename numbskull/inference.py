...
# and provides methods for inference and learning. It includes functions for 
# performing Gibbs sampling on the factor graph to estimate marginal 
# probabilities of variables. The module also defines various factor functions 
# for binary and categorical variables, as well as factor functions for 
# generative models and distribution. These functions are used for performing 
# inference and learning tasks in probabilistic graphical models. 
# ===----------------------------------------------------------------------===//\
...
def gibbsthread(shardID, nshards, var_copy, weight_copy, weight, variable,
    ...
    # print("Current position: inference.py line 16")
    ...
    # print("Current position: inference.py line 20")
...
FACTORS = {
    ...
    "UFO":  30,
    "TEMP" : 31,     # Temporary use
    "THETA": 32      # Return the corresponding theta value
}
