...
with open('data/test01_all_global_parse.pkl', 'rb') as f:  # data/all_global_parse_fg.pkl changed out
...
with open('data/test01_variables.pkl', 'wb') as v:
    pickle.dump(variables, v)
with open('data/test01_features.pkl', 'wb') as f:
